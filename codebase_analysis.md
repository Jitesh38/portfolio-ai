...
| **Supabase** | PostgreSQL database (stores users + resumes) | `lib/supabase/` |
| **OpenAI (via OpenRouter)** | AI-powered resume text → structured JSON | `app/api/extract-info/route.ts` |
